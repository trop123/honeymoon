<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Privacy.aspx.cs" Inherits="Tropical.Privacy" %>
...
<head runat="server">
  ...
  <!-- Basic -->
  <title>Privacy | andaman Honeymoon</title>
  ...
  <meta name="description" content="Andaman honeymoon tour packages">
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <ul class="contact-details">
                <li><a href="#"><i class="fa fa-headphones" style="margin: 5px;font-size: 2em;"></i> Customer Support +91-9916276420 (10 AM to 8 PM) </a>
                </li>
      ...
      <div class="navbar navbar-default navbar-top">
        <div class="container">
          <div class="navbar-header">
            ...
            <a class="" href="/" style="padding:0!important">
                <img alt="" src="https://res.cloudinary.com/getawayone/image/upload/c_scale,h_62,w_170/v1454746754/logo_gnjyca.jpg"></a>
          </div>
            ...
            <div class="blog-post gallery-post">
              ...
              <div class="post-content">
                ...
                <h2>Privacy Policy</h2>
                  ...
                  <h3 class="classic-title" style="color:#ff5a5f"><span>Privacy</span></h3>
                <p>This privacy policy is for www.andamanpackages.info and served by m/s Tropical Andaman Tours  and governs the privacy of its users who choose to use it. The policy sets out the different areas where user privacy is concerned and outlines the obligations & requirements of the users, the website and website owners. Furthermore the way this website processes, stores and protects user data and information will also be detailed within this policy.</p>
                   <h3 class="classic-title" style="color:#ff5a5f"><span>The Website</span></h3>
                <p>This website and its owners take a proactive approach to user privacy and ensure the necessary steps are taken to protect the privacy of its users throughout their visiting experience. This website complys to all India's national laws and requirements for user privacy.</p>
                
                <h3 class="classic-title" style="color:#ff5a5f"><span>Use of Cookies</span></h3>
                  ...
                  <h3 class="classic-title" style="color:#ff5a5f"><span>Contact & Communication</span></h3>
                ...
                <h3 class="classic-title" style="color:#ff5a5f"><span>Email Newsletter</span></h3>
                 ...
                 <h3 class="classic-title" style="color:#ff5a5f"><span>External Links</span></h3> 
                  ...
                  <h3 class="classic-title" style="color:#ff5a5f"><span>Adverts and Sponsored Links</span></h3>
                  <p>This website may contain sponsored links and adverts. These will typically be served through our advertising partners, to who may have detailed privacy policies relating directly to the adverts they serve.</p>
                  ...
                  <h3 class="classic-title" style="color:#ff5a5f"><span>Social Media Platforms</span></h3>
                  ...
                  <h3 class="classic-title" style="color:#ff5a5f"><span>Shortened Links in Social Media</span></h3>
